<template>
  <div class="container">
    <div class="content">
      <div class="img_div" :style="{backgroundImage:backgroundImg}">
    ...
    commodity: {
      ...
      default () {
        return {
          'position': 'center_top',
          'h2_0': '个性与舒适并存',
          'p_0': '跑车造型、R 角设计匹配指关节弧度，SHARK 造型氛围灯，',
          'p_1': '开机、来电、通知、游戏场景下，呈现不同效果。',
          'img_0': {
            'data_src': '//i1.mifile.cn/f/i/18/blackshark/index/index_phonebg.png?'
          },
          'img_1': {
            'data_src': '//i1.mifile.cn/f/i/18/blackshark/index/index_phone1.png?'
          }
        }
      }
    }
