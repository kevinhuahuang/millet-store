<template>
  <div class="container">
    <div class="content">
      <div class="title">
        <segment-title com-type="周边" :link-array="linkArray" @get-link-index="getLinkIndex"></segment-title>
      </div>
...
// import aroundJson from '@static/json/main/mi.json'
...
export default {
  ...
  created: function () {
    // this.aroundData = aroundJson
    // let data = this.aroundData['around']
